...
namespace QuickJob.Controllers
{
    public class ViewController : Controller
    {
        ...
        public ActionResult SearchJob(string k, string c, string p)
        {
            ViewBag.key = k;
            ViewBag.cate = c;
            ViewBag.pro = p;
        ...
        [HttpPost]
        public ActionResult Search(string key, string cate, string pro)
        {
            ViewBag.key = key;
            ViewBag.cate = cate;
            ViewBag.pro = pro;
            return RedirectToAction("SearchJob", new { k = key, c = cate, p = pro });
        }
    }
}